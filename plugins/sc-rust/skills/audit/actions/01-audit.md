...
- `review_target`: the Rust source files/directories identified in Step 3
- `agreed_plan`: the aggregated Rust criteria document built in Step 2
...
```
🔍 sc-rust audit — Rust code quality review

Stack detected: Axum + SQLx

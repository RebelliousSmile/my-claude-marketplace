# Harvest report contract

Only the `all` action fills this report and writes it to `aidd_docs/harvests/YYYY_MM_DD-harvest.md`. Display the full written report. If no action was taken, add `Nothing to do — directory clean.`
...
Observations ponctuelles, dérives signalées et limites.
````

...
3. Classify `behavior` against the loaded tier table (project doc, else default) into `contract`, `e2e`, or `skip`, following the decision order in the loaded source.

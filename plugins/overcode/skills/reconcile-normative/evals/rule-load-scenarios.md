...
The run fails if it only flags stale rules, only consolidates new archive entries, treats project memory as automatically loaded, or reports a load reduction without measuring the applicable entry points.

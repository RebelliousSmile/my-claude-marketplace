...
8. Select **5 distinct files** at random (or filtered by theme). Never assign the same file twice. **Never display or mention the selected files before or during the quiz — store them silently in session context.**

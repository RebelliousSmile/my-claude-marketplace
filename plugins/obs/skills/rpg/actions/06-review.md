...
Lire la prep de campagne (`synopsis.md`, `scenarios/`, `prep/`, `fronts.md`, `config.yaml`), les données d'univers liées (`R/_univers/<univers>/canon/` et `mj/` : `personnages.md`, `factions.md`, `geographie.md`) et l'`intention.md` du PJ, puis vérifier — signaler par sévérité, corriger sur demande :

...
Each finding cites a file and a fix; the verdict is "ready to play" only if no blocking remains (serving the PC, numbered fronts, canon/MJ provenance respected, game system mechanics conformant).

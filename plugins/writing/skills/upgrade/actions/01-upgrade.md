...
5. **Propose improvements**: list 3–5 specific, actionable changes with rationale. Avoid generic advice ("make it better") — name exact passages, line ranges, or structural issues.

...
- **Output format**: Markdown by default. `--format icml` exports the finished document to ICML (Adobe InCopy/InDesign) via pandoc — see `${CLAUDE_PLUGIN_ROOT}/references/export-icml.md`. Markdown stays the source.

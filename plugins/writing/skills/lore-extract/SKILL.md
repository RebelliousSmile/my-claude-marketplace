...
| #   | Action    | Role                                                         | Input                                       |
| --- | --------- | ------------------------------------------------------------ | ------------------------------------------- |
| 01  | `extract` | Validate sources → detect themes → extract → synthesize → write files | univers id + source file paths + options |

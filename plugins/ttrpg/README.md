...
Extrait de `obs` (0.26.0) — voir `plugins/obs/CHANGELOG.md`. Consomme `obs:lore-extract` et `obs:rules-keeper` (restés dans `obs`, partagés avec `writing`) pour le lore et les règles du domaine de jeu.

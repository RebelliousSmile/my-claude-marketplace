...
3. **Fill `${CLAUDE_PLUGIN_ROOT}/skills/component/references/component-spec-template.md`**: purpose, anatomy, options table, states, tokens used, responsive divergence (incl. any mobile-only pattern + desktop equivalent), accessibility.

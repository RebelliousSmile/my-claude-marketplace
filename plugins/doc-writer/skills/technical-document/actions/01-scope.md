...
1. **Classify the document type** against `${CLAUDE_PLUGIN_ROOT}/skills/technical-document/references/doc-types.md`: architecture, API/reference, integration, runbook, or design note. If the request spans two, propose splitting into linked docs.

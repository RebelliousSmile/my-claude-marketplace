...
- First scene rendered via the narration module (`references/narrateur.md`)
...
9. Render the opening scene by applying the narration module (`references/narrateur.md`) to the loaded context.

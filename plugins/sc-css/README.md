...
| `cd` | `/sc-css:cd local\|server\|automata` | Build, preview et façade de livraison d’un site statique pur. Une cible `automata` délègue son enveloppe à `overcode:deploy`; dans une application composite, sc-css contribue seulement aux assets. |

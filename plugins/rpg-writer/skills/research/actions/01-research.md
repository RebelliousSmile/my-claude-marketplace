...
- [ ] Add to terminologie.md: [terms]
- [ ] Update UNIVERS.md: [sections]
- [ ] New doc needed: [topic]
```

Saved to: `docs/research/<slug>-<date>.md`

## Process

1. Parse the research topic from `$ARGUMENTS`.
2. Load existing universe docs for comparison: `<univers>/.docs/UNIVERS.md`, `terminologie.md`, `lieux.md`, `personnages.md`, and any `docs/*.md` files.
...
8. Ask user: "Should I save this report to `docs/research/<slug>-<date>.md`?" Save on confirmation.
9. List recommended actions: terms to add to terminologie.md, sections to update in UNIVERS.md, new documentation files to create.

## Test

After `research "topic"`, verify that `docs/research/<slug>-<date>.md` exists and contains at least 3 distinct source references, a contradictions section (even if empty), and a comparison with existing docs.

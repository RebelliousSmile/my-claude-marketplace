...
1. Vérifier que `bank.yml` existe dans le répertoire courant. Sinon → STOP : "Lancer le skill depuis le répertoire du projet (`<jeu>/_ecrits/<projet>/`) ou exécuter `setup init` d'abord."

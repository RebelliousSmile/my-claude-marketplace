...
```
## Status — Audit
Saved: `aidd_docs/tasks/audits/<date>_audit_memory.md`
Score: N/10

| Priority | Criteria checked | Findings | Auto-fixed |
|----------|-----------------|----------|------------|
| P1       | 4               | N        | N          |
| P2       | 4               | N        | —          |
| P3       | 2               | N        | —          |
...
Invoke in a project with `aidd_docs/memory/`; verify `aidd_docs/tasks/audits/<date>_audit_memory.md` is created and contains P1/P2 summary tables with status indicators, a Recount log section, and a score, and that the inline summary displays the score and per-priority finding counts.

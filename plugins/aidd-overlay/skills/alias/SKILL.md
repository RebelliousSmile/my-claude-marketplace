...
| 02  | `build`       | Implement from the current plan, then run both reviews                         | current plan in context      |
...
- "implement and review", "implement then review", "alias build", "build", "implement with double review" → `build`

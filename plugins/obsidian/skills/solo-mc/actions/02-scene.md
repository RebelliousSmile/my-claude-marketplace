...
1. Apply T13 decisional grid (see SKILL.md) to every element that will be introduced or resolved in this scene. Note: any new NPC or place introduced in the scene triggers the "new named element" branch of T13 — name it, write a one-line description, and promote to `R/_campagnes/<campagne>/mj/` (or `R/_savoir/univers/<univers>/mj/` if world-level).

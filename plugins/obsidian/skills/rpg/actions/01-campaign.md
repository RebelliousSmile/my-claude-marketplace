...
`JDR/<jeu>/campagnes/<campagne>/synopsis.md` + structure de prep de campagne (`scenarios/`, `prep/`, `fronts.md`, `index.md`) + l'arborescence univers `JDR/<jeu>/univers/<univers>/.docs/{canon,mj}/` (créée ou identifiée). Lister les fronts proposés et les `[À compléter]`.
